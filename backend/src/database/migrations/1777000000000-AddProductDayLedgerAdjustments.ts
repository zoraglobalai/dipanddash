...
export class AddProductDayLedgerAdjustments1777000000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    `);
    await queryRunner.query(
      `CREATE INDEX "IDX_product_day_ledger_adjustments_date" ON "product_day_ledger_adjustments" ("date")`
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_product_day_ledger_adjustments_product" ON "product_day_ledger_adjustments" ("productId")`
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`DROP INDEX "public"."IDX_product_day_ledger_adjustments_product"`);
    await queryRunner.query(`DROP INDEX "public"."IDX_product_day_ledger_adjustments_date"`);
