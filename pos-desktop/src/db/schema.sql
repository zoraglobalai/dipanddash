...
CREATE TABLE IF NOT EXISTS gaming_bookings_local (
  ...
  system_calculated_amount REAL NOT NULL DEFAULT 0,
  extra_member_count INTEGER NOT NULL DEFAULT 0,
  extra_member_charge REAL NOT NULL DEFAULT 0,
  amount_override_reason TEXT,
  status TEXT NOT NULL,
  payment_status TEXT NOT NULL,
  payment_mode TEXT,
  paid_cash_amount REAL NOT NULL DEFAULT 0,
  paid_card_amount REAL NOT NULL DEFAULT 0,
  paid_upi_amount REAL NOT NULL DEFAULT 0,
